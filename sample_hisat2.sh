...
# The following lines (5-18) WILL change based on the computing cluster you're using, the queue system they have set up, and their installation procedures. 
# Lines 5-16 are specific to the UTC SimCenter, where this script was initially run.
...
# Identify your splice sites by running the following two lines of code, which use scripts included with the program HISAT2:
# Where A_poly_annotation.gtf is a GTF file containing annotation information for your reference genome. 
